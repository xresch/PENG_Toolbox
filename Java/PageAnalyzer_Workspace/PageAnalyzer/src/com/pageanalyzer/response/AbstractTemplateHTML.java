...
public abstract class AbstractTemplateHTML extends AbstractTemplate {
	...
	public AbstractTemplateHTML(HttpServletRequest request){
		...
		String requestID = (String)request.getAttribute(PA.REQUEST_ATTR_ID);
		long startNanos = (long)request.getAttribute(PA.REQUEST_ATTR_STARTNANOS);
...
//		<div class=\"alert alert-success\" role=\"alert\">...</div>
		...
		switch(alertType){
			...
			case PA.ALERT_SUCCESS: 	clazz = "alert-success"; break;
