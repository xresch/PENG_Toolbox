 ...
 * 
 **********************************************************************************/
public class BootstrapFooter extends HierarchicalHTMLItem {
	
	private String label = "&nbsp;";
	private UserMenuItem userMenuItem = null;
	
	public BootstrapFooter() {
	}
	...
	public BootstrapFooter setLabel(String label) {
		fireChange();
		this.label = label;
		return this;
	}
	...
	public BootstrapFooter setUserMenuItem(UserMenuItem userMenuItem) {
		fireChange();
