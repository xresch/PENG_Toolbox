	...
	static {
		...
		ArgumentDefinition configFile = 
				new ArgumentDefinition(	CONFIG_FILE, 
										...
										"The path to a config-file. The config-file can include all the arguments defined in this list delimited by newline. Also lines starting with ï¿½#ï¿½ are considered as comments, as well blank lines are allowed.");
