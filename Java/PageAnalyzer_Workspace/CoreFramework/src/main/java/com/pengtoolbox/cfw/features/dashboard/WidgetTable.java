...
public class WidgetTable extends WidgetDefinition {
	...
	public CFWObject getSettings() {
		return new CFWObject()
				...
				.addField(CFWField.newBoolean(FormFieldType.TEXT, "narrow")
						.setLabel("Narrow")
						.setDescription("Define if the table row height should be narrow or wide.")
						.setValue(false)
						)
				.addField(CFWField.newBoolean(FormFieldType.TEXT, "filterable")
						.setLabel("Filterable")
						.setDescription("Shall a filter be added to the table or not.")
						.setValue(false)
						)
				.addField(CFWField.newBoolean(FormFieldType.TEXT, "striped")
						.setLabel("striped")
